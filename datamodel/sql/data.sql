...
INSERT INTO weingutmerlot.ueberpruefungen (id, chargen_id, gaerungsprozessschritte_id, ist_zucker, ist_temperatur, ist_alkohol, anpassung_zucker, anpassung_temperatur, naechster_schritt, datum, next_date) VALUES (3, 1, 3, 530, 25, 6, 10, 0, false, NOW() + INTERVAL 2 DAY, NOW() + INTERVAL 8 DAY );
INSERT INTO weingutmerlot.ueberpruefungen (id, chargen_id, gaerungsprozessschritte_id, ist_zucker, ist_temperatur, ist_alkohol, anpassung_zucker, anpassung_temperatur, naechster_schritt, datum, next_date) VALUES (4, 2, 1, 0, 0, 0, 610, 25, true, NOW() + INTERVAL 20 DAY, null);
